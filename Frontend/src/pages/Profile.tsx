...
const Profile = () => {
  ...
  useEffect(() => {
    if (user) {
      setProfileData({
        ...
        email: user.email || "",
        phone: user.wallet_addresses?.btc || "", // Using BTC address as phone for demo
        location: "India",
        bio: `Crypto enthusiast with balance: ${user.balance || 0} XLM`,
      });
      setProfileImage(
  ...
  const handleSave = async () => {
    try {
      ...
      // If you have an API endpoint to update the profile, you would do something like:
